...
while ~out
    ...
    for i=1:numIterations
        ...
        [GradEn1,GradDe1,GradDis0,GradDis1] = dlfeval(@modelGradients1,XBatch1,paramsEn1,paramsDe1,paramsDis0,paramsDis1);
...
%% model Gradients 1
function [GradEn,GradDe,GradDis0,GradDis]=modelGradients1(x,paramsEn,paramsDe,paramsDis0,paramsDis)
...
g_loss = .999*mean(mean(.5*(x_-x).^2,1))+.0005*mean(log(1-d_output_fake+eps))+.0005*mean(log(1-d_output_fake0+eps));
