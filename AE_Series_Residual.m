...
settings.lrDe4 = 0.0002;
settings.lrDe5 = 0.0002;
% settings.lrEn1 = 0.0002;
% settings.lrDe1 = 0.0002;
...
while ~out
    ...
    for i=1:numIterations
        ...
        % Update Decoder network parameters
        [paramsDe4,avgG4.De,avgGS4.De] = adamupdate(paramsDe4,GradDe4,avgG4.De,avgGS4.De,global_iter,settings.lrDe4,settings.beta1,settings.beta2);
...
while ~out
    ...
    for i=1:numIterations
        ...
        % Update Decoder network parameters
        [paramsDe5,avgG5.De,avgGS5.De] = adamupdate(paramsDe5,GradDe5,avgG5.De,avgGS5.De,global_iter,settings.lrDe5,settings.beta1,settings.beta2);
